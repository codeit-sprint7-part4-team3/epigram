...
export default function Header() {
  ...
  return (
    <header className='fixed inset-0 z-50 flex h-52 w-full items-center justify-between border-1 border-solid border-gray-100 bg-white px-24 md:h-60 md:px-72 xl:h-80 xl:px-120'>
      {selectedHeader}
    </header>
  );
}
