...
import { mockMonthlyEmotionDatas } from './components/mockDatas';
    ...
    if (mockMonthlyEmotionDatas[monthKey]) {
      mockMonthlyEmotionDatas[monthKey].forEach(
        (mockMonthlyEmotionData: EmotionLogType) => {
          tempMonthlyEmotionDataForChart[mockMonthlyEmotionData.emotion]
            .count++;
        }
      );
    }

    setMonthlyEmotionDataForChart(tempMonthlyEmotionDataForChart);
  }, [year, month]);
            ...
            <section className='flex flex-col justify-between gap-16 xl:gap-48'>
              ...
              <div>
                <EmotionChart
                  ...
                  monthlyEmotionDatas={monthlyEmotionDataForChart}
                  windowSize='small'
                />
                <EmotionChart
